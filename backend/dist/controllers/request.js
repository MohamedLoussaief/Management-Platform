...
const substituteNames = async (req, res) => {
...
export { salaryAdvanceRequest, payslipRequest, LeaveRequest, workCertificateRequest, insuranceRequest, employeRequests, deleteRequest, storage, requests, validateRequest, cancelRequest, validatePayslipRequest, substituteNames };
